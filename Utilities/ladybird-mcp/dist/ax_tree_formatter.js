...
exports.INJECTED_AX_WALKER_SCRIPT = void 0;
exports.formatAXElementsToLineFormat = formatAXElementsToLineFormat;
/**
 * Injected script that runs inside Ladybird WebContent to build the compact element list with integer IDs
 */
exports.INJECTED_AX_WALKER_SCRIPT = `
(function() {
...
`;
function formatAXElementsToLineFormat(elements) {
